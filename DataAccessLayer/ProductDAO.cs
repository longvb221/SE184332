...
namespace DataAccessLayer
{
    public class ProductDAO
    {
        ...
        // Constructor: khởi tạo danh sách sản phẩm mặc định
        public ProductDAO()
        {
            ...
            // Các sản phẩm khác có thể được thêm bằng cách bỏ comment bên dưới:
            /*
        ...
        // Lấy danh sách sản phẩm từ bộ nhớ
        public List<Product> GetProducts()
        {
            return listProducts;
        }

        // (Nếu dùng Entity Framework + DbContext)
